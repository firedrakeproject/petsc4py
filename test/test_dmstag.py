...
# RESTORE THIS
# 'none',
STENCIL_TYPE  = ('star','box') #(PETSc.DMStag.StencilType.NONE,PETSc.DMStag.StencilType.STAR,PETSc.DMStag.StencilType.BOX)
                        ...
                        for stencil in STENCIL_TYPE:
                            ...
                            for width in STENCIL_WIDTH:
                                ...
                                def testCreate(self,kargs=kargs):
                                    ...
                                    dda.setBoundaryTypes(kargs['boundary_type'])
